package com.hsl.library.model.config;
 ...
 */
@Configuration
@ComponentScan("com.hsl.library.model")
@PropertySource("classpath:/application.properties")
public class SpringModelConfiguration {
	
	/** The Constant LOG. */
	private final static Logger LOG = LoggerFactory.getLogger(SpringModelConfiguration.class);
	...
	public DataSource getDataSource() {
		...
		result.setUrl(url);
		LOG.debug(new StringBuffer("DATABASE: ").append(url).toString());
